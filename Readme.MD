...
## Details
### The ./Updating_with_BS4/extract_transform.py script web-scrapes data from football websites that holds Premier league data. The links below are static site pages webscraped with beautiful soup, transforms it with PySpark and pandas and stores the data in the csv_dir folder
